...
@section('content')
	<h2>RootXS Terms of Use</h2>

	<h3>Overview</h3>
	<p>
		This website is operated by {!! HTML::link('//rootxs.org', 'Root XS', ['target' => '_blank']) !!}.
		Throughout the site, the terms "we", "us" and "our" refer to Root XS.
		Root XS offers this website, including all information, tools and services available from this site to you,
	...
	<p>
		...
		to be bound by the following terms and conditions ("Terms of Use", "Terms"), including those
		...
		browsers, members, and/ or contributors of content.
	</p>
	<p>
		...
		access the website or use any services. If these Terms of Use are considered an offer,
		acceptance is expressly limited to these Terms of Use.
	</p>
	<p>
		Any new features or tools which are added to the current website shall also be subject to the Terms of Use.
		You can review the most current version of the Terms of Use at any time on this page.
		We reserve the right to update, change or replace any part of these Terms of Use by posting updates and/or changes to our website.
	...
	<p>
		...
		YOU MAY CANCEL YOUR SUBSCRIPTION AT ANY TIME, BUT NO REFUNDS WILL BE ISSUED.
	...
	<p>
		...
		or other materialpurchased or obtained by you will meet your expectations,
	...
	<p>
		...
		for all purchases and donations made on our site. You agree to promptly update your account
		and other information, including your email address and credit card numbers and expiration dates,
	...
	<p>
		...
		whether online, by email, by postal mail, or otherwise (collectively, "comments"), you agree that we may,
		at any time, without restriction, edit, copy, publish, distribute, translate and otherwise use in any medium
		any comments that you forward to us. We are and shall be under no obligation
	...
	<p>
		...
		or third-parties as to the origin of any comments. You are solely responsible for any comments you makeand their accuracy.
	...
	<p>
		...
		that may relate to product descriptions, pricing, promotions, offers, product shipping charges, transit times and availability.
		We reserve the right to correct any errors, inaccuracies or omissions, and to change or update information or cancel orders
		if any information in the Service or on any related website is inaccurate at any time without prior notice
	...
	<p>
		We do not guarantee any level of spiritual, personal, or other improvement.
	</p>
	<p>
	...
	<p>
		In no case shall Root XS, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors
		...
		including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages,
		whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the Service
		...
		including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of
		the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility.
	...
	<p>
		You agree to indemnify, defend and hold harmless Root XS and our
		parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees,
		harmless from any claim or demand, including reasonable attorneys' fees, made by any third-party due to or arising out of
		your breach of these Terms of Use or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
	</p>
	...
	<p>
		...
		and the unenforceable portion shall be deemed to be severed from these Terms of Use,
	...
	<p>
		...
		You may terminate these Terms of Use at any time by notifying us that you no longer
		wish to use our Services, or when you cease using our site.
	</p>
	<p>
		If in our sole judgment you fail, or we suspect that you have failed, to comply with any term or provision of these Terms of Use,
	...
	<p>
		These Terms of Use and any policies or operating rules posted by us on this site or in respect to The Service
		...
		between you and us (including, but not limited to, any prior versions of the Terms of Use).
	</p>
	<p>
	...
	<p>
		...
		and construed in accordance with the laws of Arvada, CO, United States 80003.
	</p>

	<h3>Section 19 - Changes to Terms of Use</h3>
	<p>
		You can review the most current version of the Terms of Use at any time at this page.
	</p>
	<p>
		We reserve the right, at our sole discretion, to update, change or replace any part of these Terms of Use by
		posting updates and changes to our website. It is your responsibility to check our website periodically for changes.
		Your continued use of or access to our website or the Service following the posting of any changes
		to these Terms of Use constitutes acceptance of those changes.
	</p>

	<h3>Section 20 - Contact Information</h3>
	<p>
		Questions about the Terms of Use should be emailed to us at support [at] rootxs [dot] org.
	</p>
@endsection
